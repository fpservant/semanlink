...
<html
    ...
    <link rel="stylesheet" href="<%=contextPath%>/css/slstyles.css?v=0.7.2.j" type="text/css" />
...
//      }
    ...
    function downloadJS() {
         ...
         element.src = "<%=contextPath%>/scripts/livesearch.js?v=0.7.3-i";
         document.body.appendChild(element);
         
         element = document.createElement("script");
         element.src = "<%=contextPath%>/scripts/trees.js?v=0.7.3-i";
         document.body.appendChild(element);
    }
    </script>
