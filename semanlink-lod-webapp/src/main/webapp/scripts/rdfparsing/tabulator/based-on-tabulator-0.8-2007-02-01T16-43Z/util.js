 ...
 */
// modifications to code of tabulator-0.8-2007-02-01T16-43Z
...
Util = {
    ...
    */
	// a call to XMLHTTPFactory in Safari 3 fails:
	// "Value undefined (result of expression Util.XMLHTTPFactory) is not object."
	// This change is not good, but at least it doesn't break
	
    'enablePrivilege': function(s) {
		if (netscape) return netscape.security.PrivilegeManager.enablePrivilege(s);
	},
	
	'disablePrivilege': function(s) {
		if (netscape) return netscape.security.PrivilegeManager.disablePrivilege(s);
	}
}
