 ...
 */
public class ThesaurusIndexOK_b4SKOSIFY extends Index<SLKeyword> {
private SLModel mod;
...
ThesaurusIndexOK_b4SKOSIFY(SLModel mod, Locale locale) {
	super();
	this.mod = mod;
...
class KwLabelGetter implements LabelGetter<SLKeyword> {
	public String getLabel(SLKeyword o) {
		return o.getLabel();
	}
}
 ...
 */
protected void addItem(SLKeyword kw, boolean updateWords) {
...
public List<SLKeyword> search(String text) {
